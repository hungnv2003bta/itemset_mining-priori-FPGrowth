...
def main():
    ...
    with st.form(key='recommendation_form'):
        ...
        num_of_products_input = st.slider("Number of recommendations", min_value=1, max_value=15, value=5)
    ...
    if st.session_state.clicks.get('run_recommendation', False):
        ...
        if st.session_state.clicks.get('run_apriori', False):
            try:
                recommended_products = recommendation_system_func(df, product_ids, num_of_products, st.session_state['sorted_rules'])
